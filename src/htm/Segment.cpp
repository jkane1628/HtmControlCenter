...
{
   ProximalSynapse *newSyn = (ProximalSynapse*)(mem_manager.GetMemObject(MOT_PROXIMAL_SYNAPSE));
...
{
   DistalSynapse *newSyn = (DistalSynapse*)(mem_manager.GetMemObject(MOT_DISTAL_SYNAPSE));
